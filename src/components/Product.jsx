...
const Product = () => {
    return (
        <div className="lg:relative mt-[80px] h-fit  border border-red-500">
            <img src="./product.png" alt="" className="w-full  object-cover" />
            <div className="lg:absolute inset-0  text-center">
                ...
                <div className='mt-10 '>
                    {/* Card Grid */}
                    <div className='grid grid-cols-1 max-w-7xl mx-auto gap-5  md:grid-cols-2 lg:grid-cols-2 '>
